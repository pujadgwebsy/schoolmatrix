      ...
      <div class="mb-35 text-center text-md-start">
         <div class="row align-items-center justify-content-between">
            ...
            <div class="col-md-auto">
               <a href="blog-page.php" class="th-btn">View All Posts<i class="fa-solid fa-arrow-right ms-2"></i></a>
            </div>
         </div>
      </div>
         ...
         <div class="col-md-6 col-xl-4">
            <div class="th-blog blog-single style2">
               ...
               <div class="blog-content">
                  ...
                  <a href="enhancing-educational-connections.php" class="link-btn">Read More Details<i class="fas fa-arrow-right ms-2"></i></a>
               </div>
            </div>
         </div>
