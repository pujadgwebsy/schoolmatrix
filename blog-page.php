         ...
         <div class="col-xxl-8 col-lg-7">
            <div class="th-blog blog-single has-post-thumbnail">
               ...
               <div class="blog-content">
                  ...
                  <h2 class="blog-title"><a href="blog-details.php">Educate, Empower, Excel: Discover the Power of Learning!</a>
                  </h2>
            ...
            <div class="th-blog blog-single">
               <div class="blog-content">
                  ...
                  <h2 class="blog-title"><a href="blog-details.php">Gain insights into how parents can support childs Education at home</a>
                  </h2>
         ...
         <div class="col-xxl-4 col-lg-5">
            <aside class="sidebar-area">
               ...
               <div class="widget widget_categories  ">
                  ...
                  <ul>
                     <li><a href="service-details.php">Design</a><span>(08)</span></li>
                     <li><a href="service-details.php">Development</a> <span>(12)</span></li>
                     <li><a href="service-details.php">Photography</a><span>(15)</span></li>
                     <li><a href="service-details.php">Health</a><span>(21)</span></li>
                  ...
                  <div class="recent-post-wrap">
                     <div class="recent-post">
                        ...
                        <div class="media-body">
                           <h4 class="post-title"><a class="text-inherit" href="blog-details.php">Lorem ipsum dolor sit amet consectetur adipisicing elit.</a></h4>
                     ...
                     <div class="recent-post">
                        ...
                        <div class="media-body">
                           <h4 class="post-title"><a class="text-inherit" href="blog-details.php">Lorem ipsum dolor sit, amet consectetur adip.</a></h4>
                           <div class="recent-post-meta">
                     ...
                     <div class="recent-post">
                        ...
                        <div class="media-body">
                           <h4 class="post-title"><a class="text-inherit" href="blog-details.php">Lorem ipsum dolor sit amet consectetur.</a></h4>
                           <div class="recent-post-meta">
               ...
               <div class="widget widget_banner  " data-overlay="theme" data-opacity="9" data-bg-src="assets/img/widget/widget-banner-bg.png">
                  <div class="widget-banner">
                     ...
                     <div class="logo"><img src="assets/img/logo.png" alt="img"></div>
